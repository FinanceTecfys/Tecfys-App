...
export function filterLoanBook(rows: LoanBookRowView[], { q, status }: LoanBookFilters): LoanBookRowView[] {
  ...
  return rows.filter((r) => {
    ...
    return [r.contractNumber, r.loanBookRef, r.client, r.cif, r.distributor, r.country]
...
export const EXPORT_TOTAL_COLUMNS = ["cost", "outstanding", "settlementAmount"] as const;
